...
public class ProductDTO {
	...
	private String product_user_id; // 상품 판매자 아이디
	...
	public String toString() {
		return "ProductDTO [product_no=" + product_no + ", product_name=" + product_name + ", product_price="
				+ product_price + ", product_exp=" + product_exp + ", product_img=" + product_img + ", product_user_id="
				+ product_user_id + ", product_regdate=" + product_regdate + ", product_update=" + product_update
